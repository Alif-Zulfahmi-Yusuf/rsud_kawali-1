                                        ...
                                        <div class="py-2"><a class="dropdown-item"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="fw-normal text-body-highlight title"><span
                                                            ...
                                                            data-fa-transform="shrink-2"></span> Library
                                            ...
                                            <a class="dropdown-item"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="fw-normal text-body-highlight title"> <span
                                                            ...
                                                            data-fa-transform="shrink-2"></span> Feature
                                        ...
                                        <div class="py-2"><a class="dropdown-item"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="fw-normal text-body-highlight title"><span
                                                            ...
                                                            data-fa-transform="shrink-2"></span> Search
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-6">
                        <input class="btn-check" id="navbarPositionHorizontal" name="navigation-type" type="radio"
                            ...
                            data-page-url="/assets/backend/documentation/layouts/horizontal-navbar.html" />
                        <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionHorizontal"> <span
                                class="rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                    ...
                                    class="img-fluid img-prototype d-light-none"
                                    src="/assets/backend/img/generic/top-default-dark.png" alt="" /></span><span
                                class="label-text">
                    ...
                    <div class="col-6">
                        <input class="btn-check" id="navbarPositionCombo" name="navigation-type" type="radio"
                            ...
                            data-page-url="/assets/backend/documentation/layouts/combo-navbar.html" />
                        <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionCombo"> <span
                                class="rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                    ...
                                    class="img-fluid img-prototype d-light-none"
                                    src="/assets/backend/img/generic/nav-combo-dark.png" alt="" /></span><span
                    ...
                    <div class="col-6">
                        <input class="btn-check" id="navbarPositionTopDouble" name="navigation-type" type="radio"
                            ...
                            data-page-url="/assets/backend/documentation/layouts/dual-nav.html" />
                        <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionTopDouble"> <span
                                class="rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                    ...
                                    class="img-fluid img-prototype d-light-none"
                                    src="/assets/backend/img/generic/dual-dark.png" alt="" /></span><span
                                class="label-text">
                                Dual
                                nav</span></label>
                    </div>
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-6">
                        <input class="btn-check" id="navbarShapeSlim" name="navbar-shape" type="radio" value="slim"
                            ...
                            data-page-url="/assets/backend/documentation/layouts/horizontal-navbar.html#horizontal-navbar-slim" />
                        <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarShapeSlim"> <span
                                class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0"
                                    ...
                                    class="img-fluid img-prototype d-light-none mb-0"
                                    src="/assets/backend/img/generic/top-slim-dark.png" alt="" /></span><span
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarTopDefault"> <span
                                class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0"
                                    src="/assets/backend/img/generic/top-default.png" alt="" /><img
                                    class="img-fluid img-prototype d-light-none mb-0"
                                    src="/assets/backend/img/generic/top-style-darker.png" alt="" /></span><span
                                class="label-text">Default</span></label>
                    </div>
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarTopDarker"> <span
                                class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0"
                                    src="/assets/backend/img/generic/navbar-top-style-light.png" alt="" /><img
                                    class="img-fluid img-prototype d-light-none mb-0"
                                    src="/assets/backend/img/generic/top-style-lighter.png" alt="" /></span><span
